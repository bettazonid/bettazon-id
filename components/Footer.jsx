        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-5">
            ...
            <div className="flex gap-3 mt-6">
              ...
              <a
                href="https://www.facebook.com/bettazon.id"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="w-9 h-9 bg-gray-800 hover:bg-blue-600 rounded-full flex items-center justify-center transition-all"
              >
                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li>
                <Link href="/seller" className="hover:text-[#FE735C] transition-colors">
                  Jual di Bettazon
                </Link>
              </li>
              <li>
